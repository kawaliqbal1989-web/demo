...
function Topbar({ onToggleSidebar, onToggleSidebarCollapsed, isSidebarCollapsed = false }) {
    ...
    <>
      <header className="topbar">
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <button
            className="sidebar-collapse-toggle topbar-hide-mobile"
