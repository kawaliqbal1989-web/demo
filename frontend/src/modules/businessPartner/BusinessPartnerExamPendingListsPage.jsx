    ...
    <section style={{ display: "grid", gap: 12 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          ...
          <div style={{ fontSize: 12, color: "var(--color-text-muted)" }}>Combined lists forwarded by Franchises</div>
        </div>
      ...
      <ConfirmDialog
        ...
        message="Forward this combined list to Superadmin for approval?"
