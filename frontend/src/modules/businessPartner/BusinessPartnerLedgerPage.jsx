...
function BusinessPartnerLedgerPage() {
    ...
    <section style={{ display: "grid", gap: 12 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          ...
          <div style={{ fontSize: 12, color: "var(--color-text-muted)" }}>Financial transactions</div>
        </div>
      ...
      <div className="card" style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
        ...
        <button className="button secondary" type="button" onClick={() => void load({ limit, offset: 0 })} style={{ width: "auto" }}>
          Apply
        </button>
      </div>
...
export { BusinessPartnerLedgerPage };
