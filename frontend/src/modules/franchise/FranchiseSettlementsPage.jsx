...
import { listFranchiseSettlements } from "../../services/franchiseService";

function FranchiseSettlementsPage() {
  ...
  const load = async (next = { limit, offset }) => {
    ...
    setError("");
    try {
      const data = await listFranchiseSettlements(next);
...
export { FranchiseSettlementsPage };
