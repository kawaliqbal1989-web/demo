const FRIENDLY_BY_CODE = {
  ...
  EXAM_ENROLLMENT_NOT_FOUND: "This student is not enrolled in the selected exam cycle.",
  EXAM_LEVEL_MISMATCH: "Requested level does not match the student's enrolled exam level.",
  ...
  EXAM_ASSESSMENT_CONFIG_INCOMPLETE: "Configure every level in Assessment Configuration before final approval.",
  EXAM_ASSESSMENT_LEVEL_INVALID: "One or more configured levels are not part of this pending approval list.",
  EXAM_ASSESSMENT_WORKSHEET_INVALID: "A configured worksheet is missing or no longer eligible.",
  EXAM_ASSESSMENT_TYPE_INVALID: "Assessment type configuration is invalid. Refresh and configure again.",
  EXAM_QUESTION_BANK_REQUIRED: "Select a question bank for question-bank mode.",
  EXAM_QUESTION_BANK_EMPTY: "Selected question bank has no active questions.",
  EXAM_QUESTION_COUNT_INVALID: "Enter a valid question count greater than zero.",
  EXAM_QUESTION_COUNT_EXCEEDS_BANK: "Question count cannot be greater than available questions in selected bank.",
  EXAM_TIME_LIMIT_INVALID: "Enter a valid time limit in minutes.",
  EXAM_ASSESSMENT_NOT_QUESTION_BANK: "Question set generation is only available for question-bank configured levels.",
  ASSESSMENT_CONFIG_SCHEMA_OUTDATED: "Assessment configuration storage is not ready yet. Refresh after backend schema update completes.",
  ENROLLMENT_EXISTS: "This student is already enrolled in this batch.",
  ENROLLMENT_LEVEL_MISSING: "Active enrollment level is missing for one or more students. Update enrollment level and retry.",
